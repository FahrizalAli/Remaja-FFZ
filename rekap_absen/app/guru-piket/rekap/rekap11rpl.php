    ...
    <div class="container1">
        <div class="container_content">
            <div class="content1">
                ...
                <h2 class="main_text">11 RPL</h2>
            </div>
            <div class="content2">
                <form action="rekap_act11rpl.php" method="POST">
                    ...
                    <div class="container_input container_1">
                        ...
                        <div>
                            <input type="text" placeholder="Kelas 10" name="kelas" value="xi" disabled>
                        </div>
                    </div>
                    <div class="container_input container_1">
                        <div class="i">
    ...
    <div class="container" style="padding: 2rem 2rem;">
        <div class="info_table">
            ...
            <div class="container_down">
                <form action="rekap11rpl.php" method="get" class="form-search">
                    ...
                    <a href="rekap11rpl.php" class="icon-search2"> <i class='bx bx-reset'></i></a>
                </form>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['a']) && $_GET['b']) {
                            $nama = $_GET['a'];
                            $tanggal = $_GET['b'];
                            $query = mysqli_query($koneksi, "select t_rekap.id,t_siswa.nama,t_siswa.nis,t_siswa.jurusan,t_siswa.kelas,t_rekap.tanggal,t_rekap.ket from t_siswa inner join t_rekap on t_siswa.nis = t_rekap.nis where jurusan='Rekayasa Perangkat Lunak' AND kelas='xi' AND nama LIKE '%" . $nama . "%' and tanggal='$tanggal' ");
                        } elseif (isset($_GET['a'])) {
                            $nama = $_GET['a'];
                            $query = mysqli_query($koneksi, "select t_rekap.id,t_siswa.nama,t_siswa.nis,t_siswa.jurusan,t_siswa.kelas,t_rekap.tanggal,t_rekap.ket from t_siswa inner join t_rekap on t_siswa.nis = t_rekap.nis where jurusan='Rekayasa Perangkat Lunak' AND kelas='xi' and nama LIKE '%" . $nama . "%' ");
                        } elseif (isset($_GET['b'])) {
                            $tanggal = $_GET['b'];
                            $query = mysqli_query($koneksi, "select t_rekap.id,t_siswa.nama,t_siswa.nis,t_siswa.jurusan,t_siswa.kelas,t_rekap.tanggal,t_rekap.ket from t_siswa inner join t_rekap on t_siswa.nis = t_rekap.nis where jurusan='Rekayasa Perangkat Lunak' AND kelas='xi' and and tanggal='$tanggal' ");
                        } else {
                            $query = mysqli_query($koneksi, "select t_rekap.id,t_siswa.nama,t_siswa.nis,t_siswa.jurusan,t_siswa.kelas,t_rekap.tanggal,t_rekap.ket from t_siswa inner join t_rekap on t_siswa.nis = t_rekap.nis where jurusan='Rekayasa Perangkat Lunak' AND kelas='xi' ");
                        }
