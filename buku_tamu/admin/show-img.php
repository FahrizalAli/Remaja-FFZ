            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-md-6"><img class="rounded" style="width: 100%;" src='gambar/<?php echo $hasil['foto']; ?>' /></div>
                        <div class="col-md-6 mt-5"><img src='signature/<?php echo $hasil['ttd']; ?>' /></div>
