    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">List Buku Tamu</h1>
          ...
          <form action="riwayat-tamu.php" method="GET" style="max-height: 300px;">
            <div class="row mb-3">
              <div class="col-sm-3">
              ...
              <div class="col-sm-3 d-flex">
                <p class="mx-2">Dari</p><input class="form-control d-flex text-center" type="date" id="caritanggal" name="dua" aria-label="caritanggal">
              </div>
              <div class="col-sm-3 d-flex">
                <p class="mx-2 ">Sampai</p><input class="form-control d-flex text-center" type="date" id="caritanggal" name="tiga" aria-label="caritanggal">
              </div>
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="delete.php?id=<?= $d['id_tamu'] ?>" onclick="return confirm ('Apakah anda yakin untuk menghapus data ini?')" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fa fa-trash text-white"></i></a>
                            </td>
                            <td class="text-center">
                              <a href="edit.php?id=<?= $d['id_tamu'] ?>" onclick="return confirm ('Apakah anda yakin untuk mengubah data ini?')" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-edit text-white"></i></a>
                            </td>
                          </tr>
                          </td>
                          </tr>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <form action="input_ttd.php" method="POST">
              <input hidden type="text" name="search" value="<?php if (isset($name)) {
                                                                echo $name;
                                                              } else {
                                                                $name = "";
                                                                echo $name;
                                                              } ?>">
              <input hidden type="date" name="date1" value="<?php echo $tanggalAwal ?>">
              <input hidden type="date" name="date2" value="<?php echo $tanggalAhir ?>">
              <div id="password"></div>
              <button class="btn btn-success" onclick="guid()">Print</button>
            </form>
          </div>
